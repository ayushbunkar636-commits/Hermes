...
DEFAULT_BASE_URL = os.environ.get("BIFROST_BASE_URL") or getattr(config, "BIFROST_BASE_URL", "https://placing-reliability-container-oecd.trycloudflare.com/v1")
DEFAULT_MODEL = os.environ.get("BL_GATE_MODEL") or getattr(config, "DEFAULT_MODEL", "vertex/gemini-2.5-flash")
DEFAULT_MODEL_FALLBACK = os.environ.get("BL_GATE_MODEL_FALLBACK") or getattr(config, "DEFAULT_MODEL", "vertex/gemini-2.5-flash")
