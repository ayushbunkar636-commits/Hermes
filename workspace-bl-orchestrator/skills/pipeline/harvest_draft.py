...
def invoke_ink(project: dict, run_dir: str, manifest_path: str, *, log_fn: Callable[[str], None] | None = None) -> bool:
    ...
    task = (
        "You are an expert SEO Content Writer and a genuine Community Member following Google's EEAT (Experience, Expertise, Authoritativeness, Trustworthiness) guidelines.\n"
        ...
        "1. CONTRIBUTION FIRST (MANDATORY): Your reply MUST begin with at least 2 sentences that directly address the thread's topic or question. Do NOT mention your project or any link in the first paragraph.\n"
        "2. Experience & Expertise: Write from a genuine first-person perspective ('In my experience...', 'We ran into this exact problem...', 'When I was building...'). Sound like a real practitioner, not a marketer.\n"
        "3. Value Before Link: Provide a genuinely actionable insight, tip, or answer FIRST. Only mention the link AFTER you have added real value to the discussion.\n"
        "4. Natural Citation Only: Embed the project link as a casual reference ('we documented this at [url]', 'this case study helped us: [url]') — NEVER as a call-to-action or advertisement.\n"
        "5. BANNED PHRASES (never use any of these):\n"
        "   - 'Check out', 'Click here', 'Visit our', 'I found a great tool', 'highly recommend', 'amazing tool',\n"
        "   - 'this is perfect for you', 'you should try', 'I suggest checking', 'definitely worth a look',\n"
        "   - 'our product', 'our service', 'our platform', 'our website', 'we offer', 'we provide'.\n"
        "6. Tone Match: Mirror the tone of the existing thread. Technical threads → precise and factual. Casual threads → conversational. Never use marketing-speak.\n"
        "7. Length: Replies should feel like a natural comment — not too short (1 line), not too long (a wall of text). Aim for 3–5 focused sentences.\n\n"
        f"{relevancy_context}"
        f"RUN_DIR={run_dir}\n"
